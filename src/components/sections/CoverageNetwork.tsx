          ...
          <div className="coverage-map-col">
            <div className="coverage-map-card">
              ...
              <div className="coverage-map-body">
                ...
                >
                  <title id="coverage-map-title">Toiminta-alue ja kuljetusverkosto</title>
                  <desc id="coverage-map-desc">
                    Juha Rantakaulio Oy:n oman kaluston ydinalue Kouvolan ja
                    Jyväskylän ympärillä sekä kumppaniverkoston kattavuus koko
                    Suomessa, Pohjoismaissa ja Baltiassa.
                  </desc>

                  <defs>
                    <pattern
                      id="coverage-grid-pattern"
                      width="40"
                      height="40"
                  ...
                  <rect width="680" height="520" fill="url(#coverage-grid-pattern)" />
